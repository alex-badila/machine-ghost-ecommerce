...
See the site live: https://alex-badila.github.io/machine-ghost-ecommerce/

## Description

An ecommerce website that sells cyberpunk media, such as books and DVDs. The products are displayed in a grid format. The user chooses the quantity for each product. Each product has a Buy Now button, which, when clicked, displays the buying information to the shopping cart. To finalize their purchase the user must fill out a checkout form with their information. Once the submit button is clicked, a receipt giving all of the user's information, including an itemized list of products, is displayed. If the shopping cart is empty or there is invalid information in the checkout form, an error is displayed after the submit button is clicked.

This was the first project for my Web Application Development course as part of Humber's Web Design and Development program. It was made with my Machine Ghost Simple website as a base, which was the second and final project for my Web Development course, part of the same program. It added the functionality of the shopping cart and checkout form.
...
https://www.figma.com/design/DEz3YNiHt2wsIgY26nq98R/Machine-Ghost-eCommerce-Wireframe?node-id=0-1&t=q2Rf210OTqU2CalP-1
